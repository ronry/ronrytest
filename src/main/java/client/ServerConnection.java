...
public class ServerConnection implements Runnable, SocketConnection {
	...
	/**
	 * adds an admin to the server. If the name of the user is yours, set
	 * interal admin status
	 * 
	 * @param username
	 *            the name of the user made an admin
	 */
	...
	/**
	 * renames a user, if the name of the user is yours, rename yourself first.
	 * 
	 * @param on
	 ...
	 * 
	 * @param nc
	 *            true if a new channel, false when you have succesfully changed
	 *            channels so clear all user lists and add yourself; should be
	 *            recieving a list of any connected users in this channel
	 *            shortly
	 * @param n
	 *            the name of the channel
	 * @param p
	 *            should be null, not used here
	 */
	 ...
	 * 
	 * @param start
	 *            true when starting logging, false otherwise
	 */
	...
	/**
	 * Method to implement runnable first reports its username to the server in
	 * the form of an SD_UserAdd and listens for incoming objects
	 */
	public void run() {
